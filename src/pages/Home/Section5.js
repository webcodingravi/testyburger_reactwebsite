...
import StoreISO from "../../assets/shop/appstore.png";
   ...
   <section className="shop_section">
    <Container>
        <Row className="align-items-center">
            <Col lg={6} className="text-center text-lg-start mb-5 mb-lg-0 e_shop">
                <h4>Download mobile App and</h4>
                <h2>save up to 20%</h2>
                <p> Look for apps related to the products or services you're interested in. </p>
                <Link to="/">
                  <img src={StoreISO} alt="IOS" className="img-fluid store me-3" />
                </Link>
